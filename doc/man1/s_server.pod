...
[B<-key infile>]
[B<-keyform PEM|DER|P12>]
[B<-pass val>]
[B<-dcert infile>]
[B<-dcertform PEM|DER|P12>]
[B<-dkey infile>]
[B<-dkeyform PEM|DER|P12>]
[B<-dpass val>]
[B<-nbio_test>]
[B<-crlf>]
[B<-debug>]
...
The certificate format to use: DER, PEM, or P12. PEM is the default.
...
The private key and certificate file password source. For more information about the format of B<val>
...
=item B<-dcertform PEM|DER|P12>, B<-dkeyform PEM|DER|P12>, B<-dpass val>
