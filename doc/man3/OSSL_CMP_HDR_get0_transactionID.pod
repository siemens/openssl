...
=head1 SYNOPSIS
  ...
  ASN1_OCTET_STRING *OSSL_CMP_HDR_get0_senderNonce(const
                                                   OSSL_CMP_PKIHEADER *hdr);
...
OSSL_CMP_HDR_get0_recipNonce returns the sender nonce of the given PKIHeader.
...
OSSL_CMP_HDR_get0_senderNonce() was added in OpenSSL 3.2.
