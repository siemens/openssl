...
For instance, on connect the function may push a TLS BIO to implement HTTPS;
after disconnect it may do some diagnostic output and pop and free the TLS BIO.
