...
On receiving a response the function returns its contents as a memory BIO.
Streaming a response of indefinite length is not supported.
...
L<OSSL_HTTP_i2d(3)>, L<OSSL_HTTP_d2i(3)>, L<OSSL_HTTP_is_alive(3)>,
