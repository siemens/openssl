...
OSSL_CMP_ITAV_get0_caCerts() returns a pointer of type B<STACK_OF(X509)> to the
infoValue in the I<itav>, assuming that it has infoType B<NID_id_it_caCerts>.
...
OSSL_CMP_ITAV_get0_type(), OSSL_CMP_ITAV_get0_value(),
and OSSL_CMP_ITAV_get0_caCerts()
