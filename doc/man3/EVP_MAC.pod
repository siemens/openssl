...
EVP_MAC_CTX_get_mac_size, EVP_mac,
...
EVP_mac() computes the message authentication code
...
string I<propq>. It takes parameters I<digest> and further I<params>,
...
EVP_mac() returns a pointer to the computed MAC value, or NULL on error.
