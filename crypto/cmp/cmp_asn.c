...
ASN1_SEQUENCE(OSSL_CMP_RAND) = { /* requires CMPv3 */
    ASN1_SIMPLE(OSSL_CMP_RAND, int_, ASN1_INTEGER), /* cannot use field name "int" */
    ASN1_SIMPLE(OSSL_CMP_RAND, sender, GENERAL_NAME)
} ASN1_SEQUENCE_END(OSSL_CMP_RAND)
IMPLEMENT_ASN1_FUNCTIONS(OSSL_CMP_RAND)
...
ASN1_SEQUENCE(OSSL_CMP_CHALLENGE) = {
    ...
    ASN1_EXP_OPT(OSSL_CMP_CHALLENGE, encryptedRand, CMS_EnvelopedData, 0) /* requires CMPv3 */
#endif
...
ASN1_SEQUENCE(OSSL_CMP_CAKEYUPDANNCONTENT) = { /* deprecated */
...
ASN1_SEQUENCE(OSSL_CMP_ROOTCAKEYUPDATECONTENT) = {
    /* OSSL_CMP_CMPCERTIFICATE is effectively X509 so it is used directly */
    ASN1_SIMPLE(OSSL_CMP_ROOTCAKEYUPDATECONTENT, newWithNew, X509),
    ASN1_EXP_OPT(OSSL_CMP_ROOTCAKEYUPDATECONTENT, newWithOld, X509, 0),
    ASN1_EXP_OPT(OSSL_CMP_ROOTCAKEYUPDATECONTENT, oldWithNew, X509, 1)
} ASN1_SEQUENCE_END(OSSL_CMP_ROOTCAKEYUPDATECONTENT)
IMPLEMENT_ASN1_FUNCTIONS(OSSL_CMP_ROOTCAKEYUPDATECONTENT)

ASN1_CHOICE(OSSL_CMP_CAKEYUPDCONTENT) = {
    ASN1_SIMPLE(OSSL_CMP_CAKEYUPDCONTENT, value.cAKeyUpdAnnV2, OSSL_CMP_CAKEYUPDANNCONTENT), /* deprecated */
    ASN1_EXP(OSSL_CMP_CAKEYUPDCONTENT, value.cAKeyUpdAnnV3, OSSL_CMP_ROOTCAKEYUPDATECONTENT, 0),
} ASN1_CHOICE_END(OSSL_CMP_CAKEYUPDCONTENT)
IMPLEMENT_ASN1_FUNCTIONS(OSSL_CMP_CAKEYUPDCONTENT)
...
{
    OSSL_CMP_ITAV *itav;
    OSSL_CMP_ROOTCAKEYUPDATECONTENT *upd = NULL;

    if (newWithNew != NULL) {
        upd = OSSL_CMP_ROOTCAKEYUPDATECONTENT_new();
        if (upd == NULL)
            return NULL;
 ...
 err:
    OSSL_CMP_ROOTCAKEYUPDATECONTENT_free(upd);
    return NULL;
}
...
int OSSL_CMP_ITAV_get0_rootCaKeyUpdate(const OSSL_CMP_ITAV *itav,
                                       ...
                                       X509 **oldWithNew)
{
    OSSL_CMP_ROOTCAKEYUPDATECONTENT *upd;
...
ASN1_CHOICE(OSSL_CMP_PKIBODY) = {
    ...
    ASN1_EXP(OSSL_CMP_PKIBODY, value.ckuann, OSSL_CMP_CAKEYUPDCONTENT, 15),
