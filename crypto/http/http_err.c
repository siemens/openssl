...
static const ERR_STRING_DATA HTTP_str_reasons[] = {
    ...
    {ERR_PACK(ERR_LIB_HTTP, 0, HTTP_R_ERROR_PARSING_ULONG),
    "error parsing ulong"},
    ...
    {ERR_PACK(ERR_LIB_HTTP, 0, HTTP_R_REDIRECT_TIMEOUT), "redirect timeout"},
    {ERR_PACK(ERR_LIB_HTTP, 0, HTTP_R_RESPONSE_LINE_TOO_LONG),
    "response line too long"},
    {ERR_PACK(ERR_LIB_HTTP, 0, HTTP_R_RESPONSE_PARSE_ERROR),
    "response parse error"},
    {ERR_PACK(ERR_LIB_HTTP, 0, HTTP_R_RETRY_AFTER_TOO_LARGE),
