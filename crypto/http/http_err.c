...
static const ERR_STRING_DATA HTTP_str_reasons[] = {
    ...
    {ERR_PACK(ERR_LIB_HTTP, 0, HTTP_R_UNCERTAIN_ASN1_ENCODING),
    "uncertain asn1 encoding"},
    {ERR_PACK(ERR_LIB_HTTP, 0, HTTP_R_UNEXPECTED_ASN1_ENCODING),
    "unexpected asn1 encoding"},
